...
public class AddVird_Secreen extends AppCompatActivity {
                    ...
                    public void run() {
                        ...
                        if (title!=null&&!title.isEmpty()) {
                            ...
                            if (photoTaken!=null||!turkishText.isEmpty()){
                                ...
                                resultIntent.putExtra("fragment",previousActivity);
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Toast.makeText(getApplicationContext(),
                                                "Vird metni yada fotoğraf eklemelisiniz!",Toast.LENGTH_LONG).show();
    ...
    private Class defineNextActivity(String previousActivity){
        ...
        Class<Fragment_Tesbih_Page> nextClassTesbih= Fragment_Tesbih_Page.class;
        Class<Fragment_Salavat_Page> nextClassSalavat= Fragment_Salavat_Page.class;
